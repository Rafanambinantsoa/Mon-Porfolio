...
const _lazy_A9WZne = () => import('../handlers/renderer.mjs');

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_A9WZne, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_A9WZne, lazy: true, middleware: false, method: undefined }
];
