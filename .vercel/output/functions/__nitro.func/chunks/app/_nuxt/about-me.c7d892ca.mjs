...
import { _ as _imports_0$1, a as _imports_1$2 } from './arrow.a5315725.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!_ctx.loading) {
        ...
        _push(`<!--]--></div><div id="section-content" class="hidden lg:block w-full h-full border-right"><div id="section-content-title" class="hidden lg:flex items-center min-w-full"><img id="section-arrow-menu"${ssrRenderAttr("src", _imports_0$1)} alt="" class="section-arrow mx-3 open"><p class="font-fira_regular text-white text-sm">${unref(config).dev.about.sections[_ctx.currentSection].title}</p></div><div><!--[-->`);
        ssrRenderList(unref(config).dev.about.sections[_ctx.currentSection].info, (folder, key, index) => {
          _push(`<div class="grid grid-cols-2 items-center my-2 font-fira_regular text-menu-text"><div class="flex col-span-2 hover:text-white hover:cursor-pointer"><img id="diple"${ssrRenderAttr("src", _imports_1)} alt="" class="${ssrRenderClass({ open: _ctx.isOpen(folder.title) })}"><img${ssrRenderAttr("src", "/icons/folder" + (index + 1) + ".svg")} alt="" class="mr-3"><p${ssrRenderAttr("id", folder.title)} class="${ssrRenderClass({ active: _ctx.isActive(folder.title) })}">${key}</p></div>`);
        ...
        _push(`<!--]--></div><div id="section-content-title-contact" class="flex items-center min-w-full border-top"><img id="section-arrow-menu"${ssrRenderAttr("src", _imports_0$1)} alt="" class="section-arrow mx-3 open"><p class="font-fira_regular text-white text-sm">${unref(config).dev.contacts.direct.title}</p></div><div id="contact-sources" class="hidden lg:flex lg:flex-col my-2"><!--[-->`);
        ssrRenderList(unref(config).dev.contacts.direct.sources, (source, key) => {
          _push(`<div class="flex items-center mb-2 text-xs"><img${ssrRenderAttr("src", "/icons/" + key + ".svg")} alt="" class="mx-4"><a href="/" class="font-fira_retina text-menu-text hover:text-white">${source}</a></div>`);
        });
        _push(`<!--]--></div></div><div id="section-content" class="lg:hidden w-full font-fira_regular"><!--[-->`);
        ssrRenderList(unref(config).dev.about.sections, (section) => {
          _push(`<div><div${ssrRenderAttr("src", section.icon)} id="section-content-title" class="flex lg:hidden mb-1"><img${ssrRenderAttr("src", _imports_0$1)}${ssrRenderAttr("id", "section-arrow-" + section.title)} alt="" class="section-arrow"><p class="text-white text-sm">${section.title}</p></div><div${ssrRenderAttr("id", "folders-" + section.title)} class="hidden"><!--[-->`);
          ssrRenderList(unref(config).dev.about.sections[section.title].info, (folder, key, index) => {
            _push(`<div class="grid grid-cols-2 items-center my-2 font-fira_regular text-menu-text hover:text-white hover:cursor-pointer"><div class="flex col-span-2"><img id="diple"${ssrRenderAttr("src", _imports_1)}><img${ssrRenderAttr("src", "icons/folder" + (index + 1) + ".svg")} alt="" class="mr-3"><p${ssrRenderAttr("id", folder.title)} class="${ssrRenderClass({ active: _ctx.isActive(folder.title) })}">${key}</p></div>`);
            if (folder.files !== void 0) {
              _push(`<div class="col-span-2"><!--[-->`);
              ssrRenderList(folder.files, (file, key2) => {
                _push(`<div class="hover:text-white hover:cursor-pointer flex my-2"><img${ssrRenderAttr("src", _imports_2)} alt="" class="ml-8 mr-3"><p>${ssrInterpolate(key2)}</p></div>`);
        ...
        _push(`<!--]--><div id="section-content-title" class="flex items-center min-w-full"><img${ssrRenderAttr("src", _imports_0$1)} alt="" id="section-arrow" class="section-arrow"><p class="font-fira_regular text-white text-sm">${unref(config).dev.contacts.direct.title}</p></div><div id="contacts" class="hidden"><!--[-->`);
        ssrRenderList(unref(config).dev.contacts.direct.sources, (source, key) => {
        ...
        _push(`<!--]--></div></div></div><div class="flex flex-col lg:grid lg:grid-cols-2 h-full w-full"><div id="left" class="w-full flex flex-col border-right"><div class="tab-height w-full hidden lg:flex border-bot items-center"><div class="flex items-center border-right h-full"><p class="font-fira_regular text-menu-text text-sm px-3">${unref(config).dev.about.sections[_ctx.currentSection].title}</p><img${ssrRenderAttr("src", _imports_1$2)} alt="" class="mx-3"></div></div><div id="tab-mobile" class="flex lg:hidden font-fira_retina"><span class="text-white">// </span><h3 class="text-white px-2">${unref(config).dev.about.sections[_ctx.currentSection].title}</h3><span class="text-menu-text"> / </span><h3 class="text-menu-text pl-2">${unref(config).dev.about.sections[_ctx.currentSection].info[_ctx.folder].title}</h3></div><div id="commented-text" class="flex h-full w-full lg:border-right overflow-hidden"><div class="w-full h-full ml-5 mr-10 lg:my-5 overflow-scroll">`);
...
//# sourceMappingURL=about-me.c7d892ca.mjs.map
