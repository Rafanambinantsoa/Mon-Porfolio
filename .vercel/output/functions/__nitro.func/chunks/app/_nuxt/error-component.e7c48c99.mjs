...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404.d40d33af.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500.9909d326.mjs').then((r) => r.default || r));
...
//# sourceMappingURL=error-component.e7c48c99.mjs.map
